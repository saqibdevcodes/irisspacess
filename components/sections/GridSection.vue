<template>
  <section class="section-padding bg-gray-50">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 animate-stagger">
      ...
      >
        <div class="relative aspect-[4/3] rounded-lg overflow-hidden shadow-lg">
          <img 
            :src="item.image" 
            :alt="item.title"
          ...
          <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div class="space-y-6">
              ...
              <div class="flex space-x-4">
                ...
                <button 
                  v-if="selectedItem?.relatedPage"
                  @click="navigateToRelated(selectedItem.relatedPage)"
